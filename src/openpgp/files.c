...
file_entry_t openpgp_file_entries[] = {
...
const file_t *file_openpgp = &openpgp_file_entries[sizeof(openpgp_file_entries) / sizeof(file_entry_t) - 2].file;

INITIALIZER(openpgp_files_ctor) {
    file_register_namespace(2, openpgp_file_entries, sizeof(openpgp_file_entries) / sizeof(file_entry_t));
}
