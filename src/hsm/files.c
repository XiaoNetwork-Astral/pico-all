...
const file_t *file_sc_hsm = &hsm_file_entries[sizeof(hsm_file_entries) / sizeof(file_entry_t) - 2].file;
file_t *file_pin1 = NULL;
file_t *file_retries_pin1 = NULL;
file_t *file_sopin = NULL;
file_t *file_retries_sopin = NULL;

INITIALIZER(hsm_files_ctor) {
    file_register_namespace(3, hsm_file_entries, sizeof(hsm_file_entries) / sizeof(file_entry_t));
}
