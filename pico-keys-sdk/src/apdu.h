...
extern int register_app_for_fido(int (*)(app_t *, uint8_t), const uint8_t *);
extern int register_app_for_openpgp(int (*)(app_t *, uint8_t), const uint8_t *);
extern int register_app_for_hsm(int (*)(app_t *, uint8_t), const uint8_t *);
