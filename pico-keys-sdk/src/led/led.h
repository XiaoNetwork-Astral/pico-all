...
enum  {
    MODE_NOT_MOUNTED = (HALF_BTNESS << LED_BTNESS_SHIFT) | (LED_COLOR_MAGENTA << LED_COLOR_SHIFT) | (200 << LED_ON_SHIFT) | (1800 << LED_OFF_SHIFT),
    MODE_MOUNTED     = (MAX_BTNESS << LED_BTNESS_SHIFT) | (LED_COLOR_GREEN << LED_COLOR_SHIFT) | LED_ON_NO_BLINK,
    MODE_SUSPENDED   = 0,
    MODE_PROCESSING  = (HALF_BTNESS << LED_BTNESS_SHIFT) | (LED_COLOR_BLUE << LED_COLOR_SHIFT) | LED_ON_NO_BLINK,
