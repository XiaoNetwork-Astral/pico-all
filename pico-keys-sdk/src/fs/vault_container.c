...
static picokeys_vault_state_t vault_states[FILE_NAMESPACE_COUNT];
#define vault_state vault_states[file_namespace_current()]
...
static const file_object_container_layout_t vault_layout = {
    .ctx = NULL, // Callbacks select the app state via file_namespace_current()
